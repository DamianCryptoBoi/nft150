...
//import './interfaces/IOldMarket.sol';
//
...
//}
//
//contract SotaMarket is Manager, ERC1155Holder, ERC721Holder, ReentrancyGuard {
...
//			(address owner, address tokenAddress, address paymentToken, uint256 tokenId, uint256 quantity, , , , uint256 price, ) = IOldMarket(oldMarket).items(i);
//
//			Order memory newOrder;
//			newOrder.isOnsale = true;
...
//			orderID[_id] = _orderId;
//			if (quantity > 0) {
//				IOldMarket(oldMarket).adminCancelList(i, address(this));
//			}
//		}
//	}
//
//	function transferOwnerOldMarket(address _newOwner) external onlyOwner() {
//		IOldMarket(oldMarket).transferOwnership(_newOwner);
//	}
//
