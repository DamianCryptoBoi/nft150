    ...
    WhitelistAdminRole
{
    ...
    event Create(address indexed _creator, uint256 indexed _id,uint indexed _loyaltyFee, uint256 _maxSupply, uint256 _initSupply);
    ...
    function create(
        ...
        string memory _uri,
        bytes memory _data
    ) public onlyWhiteListCreator returns (uint256 tokenId) {
        require(
