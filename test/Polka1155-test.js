...
describe('Unit testing - Polka1155', function () {
	...
	describe('Transactions', function () {
		...
		it('create - maxSupply - totalSupply - getLoyaltyFee - getCreator', async function () {
			await expect(polka1155.create(1000, 1001, 200, '_uritest', 1)).to.be.revertedWith(
			...
			await expect(polka1155.connect(addr).create(1000, 100, 10001, '_uritest', 1)).to.be.revertedWith(
				'Only-white-list-can-create'
			);
