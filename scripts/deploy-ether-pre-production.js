...
const main = async () => {
      ...
      const polkaURI = await PolkaURI.deploy("https://assets.polkafantasy.com/");
      ...
      await marketV3.setPaymentMethod(
            "0xEA040dB91b2FB439857145D3e660ceE46f458F94", // usdt -> production change -> 0xdac17f958d2ee523a2206206994597c13d831ec7
            true);
